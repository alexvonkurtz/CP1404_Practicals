...
# Write  a  program  that  asks  the  user  for  their  name,  then  opens  a  file  called  “name.txt”  and  writes  that
# name  to  it.
...
#(AS NOTED IN ANSWERS: Note that .strip() is unnessary since int() handles that whitespace
...
# Extended solution as stated by the answers
in_file = open("numbers.txt", "r")
total = 0
for line in in_file:
    number = int(line)
